#!/usr/bin/env python3
"""
generate_reflejo_personalidad.py — OilShield™ GT
Ángulo: El Reflejo de tu Personalidad — "Tu carro dice quién sos"
Avatar: Hombres y mujeres 25-55 que ven su vehículo como extensión de su identidad.
...
OUT = os.path.join(os.path.dirname(__file__), "..", "..", "Arquitecto de landing",
                   "angulo_reflejo_personalidad_oilshield_gt.html")

# Reutilizamos el mismo CSS base de la estructura R2R
CSS = """
...
def CTA_INLINE(): return '<div class="cta-inline"><a href="#" class="btn-in">QUE MI CARRO REFLEJE QUIÉN SOY<span>Pagás solo cuando el mensajero llega</span></a></div>'
...
<div class="sec-bar">ESTRUCTURA DE VENTAS — ÁNGULO REFLEJO DE TU PERSONALIDAD</div>"""

def h_topbar():
    return S('<div class="top-bar">🚗 Envío GRATIS a toda Guatemala &nbsp;|&nbsp; Tu carro habla por vos — Pagás Solo al Recibir 🔒</div>')
...
def h_hero():
  ...
  <div class="hero-copy">
    ...
    <div class="hero-reviews">+3,800 personas que ya hacen que su carro hable por ellos</div>
    <h1 class="hero-h1">Tu carro es el reflejo de quién sos. ¿Qué dice el tuyo ahora mismo?</h1>
    <div class="hero-sub">OilShield™ devuelve a tus cristales la transparencia perfecta que refleja tu nivel de exigencia.</div>
    <div style="margin-bottom:16px;">
      <div class="price-old">PRECIO NORMAL: Q350</div>
      <span class="price-new">Q249</span><span class="badge-off">29% OFF</span>
    </div>
    <div class="prod-name">OilShield™ — Limpiador Nano-Molecular Premium</div>
    <ul class="checks">
      <li><span class="chk">✔</span> Cristales impecables que reflejan tu nivel de cuidado</li>
      <li><span class="chk">✔</span> La misma tecnología que usan los detailers profesionales</li>
      <li><span class="chk">✔</span> Resultado que dura semanas — no días</li>
      <li><span class="chk">✔</span> 5 minutos. Desde tu cochera. Sin depender de nadie.</li>
    </ul>
    <div class="hero-test">"Mi carro dice mucho de mí ante mis clientes. Desde que uso OilShield™, mis cristales lucen impecables y doy la imagen profesional que quiero proyectar." — Sofía T., 34 años, Zona 14 ✅ Compradora verificada</div>
    <button class="btn-cta">QUE MI CARRO REFLEJE QUIÉN SOY — PAGAR AL RECIBIR<span>Pagás solo cuando el mensajero llega a tu puerta</span></button>
  </div>
</div>"""))

def h_garantias():
    return S(W("""<div class="gbar">
  <div class="gitem"><div class="gico">🛡️</div><div class="gtxt"><strong>GARANTÍA 30 DÍAS</strong><span>Resultado visible o devolvemos tu pisto.</span></div></div>
  ...
  <div class="gitem"><div class="gico">🪞</div><div class="gtxt"><strong>TU IMAGEN, TU REFLEJO</strong><span>Un carro impecable = una persona impecable.</span></div></div>
</div>
<div class="logos-bar">
...
def h_transformacion():
  ...
  <h2>De "Está Descuidado" a "Ese Carro Tiene Dueño de Verdad"</h2>
  <p>La diferencia entre un carro que pasa desapercibido y uno que proyecta personalidad son 3 pasos de 5 minutos.</p>
</div>
<div class="steps">
  <div class="step"><div class="step-lbl">PASO 1</div><div class="step-img">💧</div><p><strong>Aplicá 3-4 sprays</strong> de OilShield™ sobre el cristal seco. Cubrí todo el parabrisas.</p></div>
  <div class="step"><div class="step-lbl">PASO 2</div><div class="step-img">🧴</div><p><strong>Distribuí con la esponja</strong> en círculos por 2 minutos. Sentís cómo el aceite invisible se suelta.</p></div>
  <div class="step"><div class="step-lbl">PASO 3</div><div class="step-img">🪞</div><p><strong>Pasá un paño seco</strong> y mirá el reflejo. Cristalino, impecable — como reflejo de quién sos.</p></div>
</div>
{CTA_INLINE()}"""))

def h_autoridad():
    return S(BAR("La Ciencia de la Primera Impresión","1rem") + W("""<div class="auth-grid">
  <div class="auth-img">🔬</div>
  <div class="auth-copy">
    <h2>La gente juzga en 7 segundos. Tu carro habla antes que vos.</h2>
    <p>Estudios de psicología social demuestran que formamos una impresión en <strong>7 segundos</strong>. Tu vehículo es una de las primeras cosas que la gente ve — clientes, vecinos, colegas. Un parabrisas opaco y grasoso envía un mensaje que no querés dar.</p>
    <p><strong>OilShield™ usa tecnología nano-molecular</strong> para eliminar esa capa invisible de aceite que hace que tu cristal se vea descuidado. Es la diferencia entre un carro que pasa desapercibido y uno que proyecta personalidad.</p>
    <div class="auth-dot"><div class="dot"></div><span>El 85% de las personas asocian un vehículo limpio con una persona exitosa y responsable.</span></div>
    <div class="auth-dot"><div class="dot"></div><span>Un parabrisas con aceite invisible reduce la percepción de valor del vehículo hasta un 30%.</span></div>
    <div class="auth-dot"><div class="dot"></div><span>+3,800 conductores guatemaltecos ya proyectan su mejor imagen con OilShield™.</span></div>
  </div>
</div>"""))
...
{W(f'''<div class="benef-hd">
  <h2>Tu carro impecable = tu personalidad visible</h2>
  <p>No es vanidad. Es coherencia. Si cuidás tu imagen, tu casa, tu trabajo — tu carro debe reflejar lo mismo.</p>
</div>
<div class="benef-3col">
  <div>
    <div class="bc"><h3>Reflejo 1: Imagen Profesional</h3><p>Llegás a una reunión con cristales impecables. Antes de abrir la boca, tu carro ya habló por vos.</p></div>
    <div class="bc"><h3>Reflejo 2: Atención al Detalle</h3><p>Las personas exitosas cuidan los detalles. Un parabrisas cristalino es ese detalle que marca la diferencia.</p></div>
    <div class="bc"><h3>Reflejo 3: Orgullo Personal</h3><p>Ese momento de satisfacción cuando subís al carro y los cristales brillan. Es tu recompensa diaria.</p></div>
  </div>
  <div class="bc-center"><div class="bc-img">🪞</div></div>
  <div>
    <div class="bc"><h3>Reflejo 4: Consistencia</h3><p>Una aplicación dura semanas. Tu imagen se mantiene impecable sin esfuerzo adicional.</p></div>
    <div class="bc"><h3>Reflejo 5: Independencia</h3><p>Vos mismo lo hacés en 5 minutos. Sin depender de lavaderos, sin citas, sin esperas.</p></div>
    <div class="bc"><h3>Reflejo 6: Cero Riesgo</h3><p>Garantía 30 días + COD. Si no refleja lo que querés, devolvemos tu pisto.</p></div>
  </div>
</div>
{CTA_INLINE()}''')}
</div>""")
...
def h_como_usarlo():
    pasos = [
        ("01","Limpiá el polvo grueso","Paño seco sobre el cristal seco, a temperatura ambiente."),
        ("02","Aplicá 3-4 sprays de OilShield™","Rociá especialmente donde se ve más opaco el cristal."),
        ("03","Frotá con la esponja en movimientos circulares","2 minutos. La fórmula disuelve la capa invisible que opaca tus cristales."),
        ("04","Pasá un paño seco y contemplá tu reflejo","Cristal transparente y perfecto. Tu carro vuelve a reflejar quién sos."),
    ]
  ...
  <div class="bexp-copy">
    <h2>4 Pasos Para Que Tu Carro Refleje Quién Sos</h2>
    <div class="sub">Sin experiencia, sin equipo especial. Resultado perfecto desde la primera vez.</div>
    <div style="margin-top:8px;">{ps}</div>
  </div>
</div>
<div class="tip-box"><strong>💡 TIP PRO:</strong> Aplicá de noche o en sombra para mejores resultados. El cristal frío absorbe mejor la fórmula.</div>
{CTA_INLINE()}"""))

def h_caracteristicas():
    specs = [
        ("01","Fórmula Nano-Molecular Profesional","Penetra microporos del vidrio y disuelve depósitos invisibles de aceite. Misma tecnología de detailing premium."),
        ("02","8-12 Aplicaciones por Frasco","Rinde 3-6 meses. Tu imagen se mantiene impecable durante meses con una sola compra."),
        ("03","Resultado en 5 Minutos","Fórmula de activación inmediata. Impacto visual desde el primer uso."),
        ("04","Compatible con Todo Vehículo","Carros, SUVs, pick-ups. Vidrio templado, laminado y tintado. No daña nada."),
        ("05","pH Neutro — Seguro para Tintes","Sin amoniaco, sin solventes agresivos. Tu polarizado queda intacto."),
        ("06","Efecto Hidrofóbico Duradero","Repele agua, polvo y aceite nuevo. Tu imagen impecable dura semanas."),
    ]
  ...
  <p style="font-size:.88rem;color:#555;">La tecnología detrás de una imagen impecable.</p>
</div>
...
def h_comparativa():
    ...
    lavadero = col("Lavadero / Detailer", [(False,"Q200-Q400 cada vez"),(False,"Mismo resultado genérico para todos"),(False,"Tu carro sale igual que los demás"),(False,"3-5 días de resultado"),(False,"1-2 horas perdidas")], False)
    oilshield = col("OilShield™", [(True,"Q249 una sola vez"),(True,"Resultado premium personalizado"),(True,"Tu carro se distingue del resto"),(True,"3-6 semanas de resultado"),(True,"5 minutos en tu casa")], True)
    otros = col("Otros Limpiadores", [(False,"Precio similar"),(False,"Limpieza superficial genérica"),(False,"No elimina la capa de aceite"),(False,"Resultado efímero"),(False,"Múltiples pasadas")], False)
    return S(f"""<div style="background:#f9f5f2;">
{BAR("¿Por Qué OilShield™ y No Otra Cosa?","1rem")}
{W(f'<div class="comp-grid">{lavadero}{oilshield}{otros}</div>{CTA_INLINE()}')}
</div>""")

def h_testimonios():
    T = [
        ("👩","Sofía T.","Zona 14, 34 años","«Mi CX-5 es mi oficina rodante. Mis clientes me ven llegar y mi carro dice todo. Desde OilShield™, mis cristales reflejan exactamente quién soy.»"),
        ("👴","Don Carlos M.","Mixco, 58 años","«Llevo 25 años cuidando mis carros. Mi Hilux es parte de mí. OilShield™ devuelve esa transparencia que dice que el dueño sí cuida lo suyo.»"),
        ("👨","Roberto A.","Antigua Guatemala, 51 años","«Soy muy exigente con mi imagen personal. Mi carro no puede ser la excepción. OilShield™ me da ese acabado premium que necesito.»"),
        ("👩","María Elena G.","Villa Nueva, 42 años","«Mi carro lleva a mis hijos al colegio y a mí al trabajo. Tiene que verse bien porque yo me veo bien. OilShield™ me da eso.»"),
        ("🧔","Kevin L.","Guatemala Capital, 27 años","«En los car meets, la gente se fija en los detalles. Los cristales de mi carro ahora brillan más que los de muchos carros del doble de precio.»"),
        ("👨","Ernesto V.","Escuintla, 44 años","«3 vehículos en la familia. Todos con OilShield™. Los vecinos me preguntan qué uso. Mi carro siempre se ve mejor que todos.»"),
    ]
    ...
    return S(W(f'<div class="test-hd"><h2>Personas que Ya Reflejan Su Personalidad a Través de Su Carro</h2></div><div class="test-grid">{cards}</div>'))

def h_incluye():
    items = [("01","1 frasco OilShield™ (fórmula nano-molecular)"),("02","1 esponja aplicadora de alta densidad"),("03","Guía de aplicación paso a paso"),("04","Envío GRATIS a toda Guatemala"),("05","Pago contra entrega — sin tarjeta"),("06","Garantía 30 días sin preguntas")]
...
def h_logistica():
  ...
  <p>Principales transportadoras de Guatemala. <strong>Pagás solo cuando el mensajero llega.</strong> Sin riesgo.</p>
  <div class="carriers">
...
def h_oferta():
    return S(W(f"""<div class="oferta-hd"><h2>Elegí Tu Nivel de Imagen</h2></div>
<div class="oferta-grid">
  <div class="oc"><div class="oc-hd"><h3>BÁSICO</h3></div><div class="oc-body"><div class="oc-p">Q249</div><div class="oc-old">Antes Q350</div><ul><li>1 frasco OilShield™</li><li>1 esponja aplicadora</li><li>Envío GRATIS</li><li>Garantía 30 días</li></ul><a href="#" class="oc-btn">REFLEJAR MI PERSONALIDAD</a></div></div>
  <div class="oc best"><div class="oc-hd"><h3>IMAGEN TOTAL</h3><div class="best-tag">⭐ MÁS POPULAR</div></div><div class="oc-body"><div class="oc-p" style="color:#7B1818;">Q399</div><div class="oc-old">2 frascos — Antes Q700</div><ul><li>2 frascos OilShield™</li><li>2 esponjas aplicadoras</li><li>Envío GRATIS prioritario</li><li>Garantía 30 días extendida</li><li>1 paño microfibra premium GRATIS</li></ul><a href="#" class="oc-btn">ELEGIR IMAGEN TOTAL</a></div></div>
...
def h_faq():
    Q = [
        ("¿Funciona en cualquier tipo de vidrio?","Sí. Compatible con vidrio templado, laminado y tintado. No daña sellos ni polarizado."),
        ("¿Cómo funciona el pago contra entrega?","El mensajero llega a tu puerta. Inspeccionás y pagás. Sin tarjeta, sin riesgo."),
        ("¿Cuánto tarda el envío?","Capital: 1-2 días. Resto del país: 2-4 días. GRATIS a toda Guatemala."),
        ("¿Cuánto dura el efecto?","3-6 semanas. Tu imagen se mantiene impecable sin esfuerzo adicional."),
        ("¿Puedo usarlo en otros cristales del carro?","Sí. Ventanas laterales, trasera y espejos. Todo tu carro reflejará tu nivel de cuidado."),
...
def h_cta_final():
  ...
  <h2>Tu carro habla antes que vos. Hacé que diga lo correcto.</h2>
  <p>Un parabrisas impecable refleja una persona impecable. Garantía 30 días. Pagás solo al recibir.</p>
  <a href="#" class="btn-big">✅ QUE MI CARRO REFLEJE QUIÉN SOY — PAGAR AL RECIBIR</a>
  <div class="sub-cta">Sin tarjeta · Sin riesgo · Envío gratis a toda Guatemala 🇬🇹</div>
</div>"""

def h_footer():
    return '<div class="r2r-footer">Generado con <span>ROOKIE 2 RICHES — EGS Framework 2026</span> · OilShield™ Guatemala · Ángulo: Reflejo de tu Personalidad</div>'

B1 = bexp(1,"Tu Carro Es tu Carta de Presentación","No es vanidad — es comunicación.",
    "Cada vez que llegás a un lugar, tu carro habla antes que vos. Un parabrisas opaco dice descuido. Un cristal impecable dice: esta persona cuida los detalles.",
    ["<strong>Primera impresión:</strong> El 85% de las personas juzgan por el vehículo.",
     "<strong>Coherencia:</strong> Si cuidás tu apariencia, tu carro debe reflejar lo mismo.",
     "<strong>Diferencial:</strong> En un estacionamiento lleno, tu carro se distingue."],
    "🪞")
B2 = bexp(2,"Resultado Premium, Precio Accesible","Un detailer te cobra Q400. OilShield™ te da lo mismo por Q249.",
    "No necesitás gastar Q400 cada semana para mantener tu imagen. Una aplicación de OilShield™ te da el acabado de detailing profesional por semanas — desde tu cochera.",
    ["<strong>Ahorro inteligente:</strong> Q249 vs Q400/lavadero, resultado superior.",
     "<strong>Autonomía:</strong> Vos mismo lo hacés, cuando querés, donde querés.",
     "<strong>Profesional:</strong> Misma tecnología nano-molecular que usan los detailers."],
    "💎", reverse=True)
B3 = bexp(3,"Visibilidad Perfecta = Confianza al Volante","No solo se trata de verse bien. Se trata de ver bien.",
    "El aceite invisible en tu parabrisas crea reflejos peligrosos de noche. OilShield™ los elimina. Manejás con confianza porque ves con claridad total.",
    ["<strong>Seguridad real:</strong> Visión nocturna sin reflejos cegadores.",
     "<strong>Lluvia sin miedo:</strong> El agua se desliza — no se pega.",
     "<strong>Confianza:</strong> Manejás sabiendo que ves todo con claridad."],
    "🌙")
B4 = bexp(4,"Tu Imagen Dura Semanas","Aplicás una vez — tu reflejo se mantiene.",
    "La capa nano-molecular de OilShield™ no solo limpia — protege. Repele aceite nuevo, agua y polvo por semanas. Tu imagen impecable se mantiene sin esfuerzo.",
    ["<strong>Protección activa:</strong> La capa hidrofóbica trabaja por vos.",
     "<strong>Menos mantenimiento:</strong> Sin lavaderos semanales.",
     "<strong>Consistencia:</strong> Tu carro siempre refleja tu estándar."],
    "⏱️", reverse=True)
B5 = bexp(5,"5 Minutos que Cambian Tu Imagen","Hacélo vos. Sin cita. Sin espera. Sin depender de nadie.",
    "En el tiempo que tardás en tomar café, podés transformar la imagen de tu vehículo. El kit viene con todo. Si podés limpiar con un paño, podés usar OilShield™.",
    ["<strong>Kit completo:</strong> Frasco + esponja + guía paso a paso.",
     "<strong>Sin curva de aprendizaje:</strong> Resultado perfecto desde el primer uso.",
     "<strong>Independencia total:</strong> Tu imagen, tu tiempo, tu decisión."],
    "🎯")
B6 = bexp(6,"Cero Riesgo — Tu Imagen Garantizada","Si tu carro no refleja lo que querés, devolvemos tu pisto.",
    "Pagás al recibir. Si en 30 días no ves el resultado prometido, te devolvemos el dinero completo. Así de seguros estamos del reflejo que vas a ver.",
    ["<strong>Pago contra entrega:</strong> Sin tarjeta, sin transferencia.",
     "<strong>Garantía 30 días:</strong> Sin preguntas. Sin complicaciones.",
     "<strong>+3,800 reflejos perfectos:</strong> La comunidad no miente."],
    "🛡️", reverse=True)
...
<head>
  ...
  <title>OilShield™ Guatemala — El Reflejo de Tu Personalidad | ROOKIE2RICHES</title>
...
<body>{body}</body>
    ...
    with open(OUT, "w", encoding="utf-8") as f:
        f.write(html)
    print(f"✅ Landing reflejo personalidad generada: {OUT}")
